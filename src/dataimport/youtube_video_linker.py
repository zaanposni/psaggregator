...
async def youtube():
    ...
    for channel in channel_ids:
        ...
        for video in yt_data:
            ...
            query = f"SELECT * FROM ContentPiece WHERE title LIKE :title AND startDate BETWEEN :lowerBoundary and :upperBoundary AND importedFrom = 'PietSmietDE' AND type = 'PSVideo'"
            values = {
                "title": title,
